...
// دالة لإعلام المسؤول بوجود طلب جديد
function notifyAdmin() {
  const loggedInUser = getLoggedInUser();
  if (loggedInUser && loggedInUser.role === 'admin') {
    // يمكنك استخدام تنبيه بسيط أو تحديث عنصر واجهة مستخدم مخصص للإشعارات
    alert("هناك طلب جديد وارد! يرجى التأكد من لوحة الإدارة.");
    
    // أو يمكنك تحديث عنصر إشعار موجود في لوحة الإدارة مثل:
    // document.getElementById("adminNotification").textContent = "طلب جديد وارد";
  }
}
...
document.getElementById('orderForm').addEventListener('submit', function(e) {
  ...
  // هنا نقوم بإبلاغ المسؤول إذا كان مسجلاً
  notifyAdmin();
